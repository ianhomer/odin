...
/**
 * Sequenced Operation Handler.  Note that the operation handler extends a PerformanceListener
 * since the time that the operation is sent is a performance time.  If the handler has it's
 ...
 */
public interface OperationHandler extends PerformanceListener {
  /**
