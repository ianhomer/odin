...
public class TickConverterTest {
  ...
  public void testConvertToMilliseconds() {
    ...
    converter = new DefaultTickConverter(clock, RuntimeTicks.HALF, RuntimeTicks.MILLISECOND, 0);
  ...
  public void testConvertToMicroseconds() {
    ...
    converter = new DefaultTickConverter(clock, RuntimeTicks.HALF, RuntimeTicks.MICROSECOND, 0);
  ...
  public void testConvertToMicrosecondsWithOffset() {
    ...
    converter = new DefaultTickConverter(clock, RuntimeTicks.HALF, RuntimeTicks.MICROSECOND, 1);
  ...
  public void testConvertToBeat() {
    ...
    converter = new DefaultTickConverter(clock, RuntimeTicks.MILLISECOND, RuntimeTicks.BEAT, 0);
  ...
  public void testConvertToHalfBeat() {
    ...
    converter = new DefaultTickConverter(clock, RuntimeTicks.MILLISECOND, RuntimeTicks.HALF, 0);
