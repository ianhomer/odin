...
public class StaticMeasureProviderTest {
    ...
    public void testMeasure() {
        ...
        assertEquals(0, measureProvider.getTickPosition(new Tock(Tick.HALF_BEAT, 0)));
        assertEquals(1, measureProvider.getTickPosition(new Tock(Tick.HALF_BEAT, 1)));
        assertEquals(7, measureProvider.getTickPosition(new Tock(Tick.HALF_BEAT, 7)));
        assertEquals(4, measureProvider.getTickPosition(new Tock(Tick.HALF_BEAT, 12)));
